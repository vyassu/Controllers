...
class BroadCastForwarder(ControllerModule):
    def __init__(self ,CFxHandle, paramDict, ModuleName):
        ...
        for k in range(len(tincanparams)):
            ...
            self.ipop_interface_details[interface_name]["uid"] = tincanparams[k]["uid"]
    ...
    def processCBT(self, cbt):
        ...
        if cbt.action == 'ONLINE_PEERLIST':
            ...
            self.ipop_interface_details[interface_name]["mac"] = cbt.data.get("mac", None)
    ...
    def sendtopeer(self, data, datype):
        ...
        if self.ipop_interface_details[interface_name]["peerlist"]:
            ...
            if data["type"] == "local":
                ...
                self.sendto_all_peers(sorted(self.ipop_interface_details[interface_name]["peerlist"]),
            ...
            self.registerCBT('LinkManager', 'TINCAN_CONTROL', {"interface_name": data["interface_name"],
